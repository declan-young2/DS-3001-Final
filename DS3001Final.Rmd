...
The 75th percentile of danceability includes values of .687 and above
...
=======
>>>>>>> da3bed64babd66db23a7230c55924135ec8198a2
...
``` {r}
ggplot(empty2, aes(x = reorder(as.factor(CF_level), -F1), y = F1))+ geom_col(width = .8)+ geom_bar(data=subset(empty2, CF_level==.6), aes(as.factor(CF_level), F1),
              fill="green", stat="identity")
ggplot(empty2, aes(x = reorder(as.factor(CF_level), -specificity), y = specificity))+ geom_col(width = .8)+ geom_bar(data=subset(empty2, CF_level==.6), aes(as.factor(CF_level), specificity),
>>>>>>> da3bed64babd66db23a7230c55924135ec8198a2
              fill="green", stat="identity")
```
